...
import { Invoice, InvoiceModel, InvoiceModelName } from '@common/schemas/invoice.schemas';
...
export class InvoiceRepository {
    ...
    deleteById(id: string, data: Partial<Invoice>) {
        return this.invoiceModel.findByIdAndDelete(id, data);
    }
}
